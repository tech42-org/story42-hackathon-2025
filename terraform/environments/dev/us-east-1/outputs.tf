...
output "regenerate_segment_image_endpoint" {
  ...
  value       = module.api_gateway.regenerate_segment_image_endpoint
  }
...
output "story_image_lambda_function_name" {
  ...
  value       = module.story_image_lambda.lambda_function_name
  }
...
output "generate_topics_ideas_endpoint" {
  ...
  value       = module.api_gateway.generate_topics_ideas_endpoint
  }
